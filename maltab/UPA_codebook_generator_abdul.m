function [F_CB,all_beams]=UPA_codebook_generator_abdul(Mx,My,Mz,over_sampling_x,over_sampling_y,over_sampling_z,ant_spacing)
...
start_angle = 48.1 / 180 * pi;
end_angle = 136.2 / 180 * pi;
angle_FoV = end_angle - start_angle;

theta_qx=start_angle:angle_FoV/codebook_size_x:end_angle-1e-6; % quantized beamsteering angles
