...
load('all_acc_train_on_synth4.mat');
load('all_pwr_train_on_synth4.mat');
...
all_acc_train_on_synth4 = squeeze(mean(all_acc_train_on_synth4, 2));
all_pwr_train_on_synth4 = squeeze(mean(all_pwr_train_on_synth4, 2));
...
ylim([0.3, 1]);
legend('Acc. (trained on real)', 'Power (trained on real)', 'Acc. (trained on synth.)', 'Power (trained on synth.)', 'Acc. (transfer learining)', 'Power (transfer learining)');