...
all_acc_train_on_transfer_final = squeeze(mean(all_acc_train_on_transfer_final_batch8_beamsteer2, 2));
all_pwr_train_on_transfer_final = squeeze(mean(all_pwr_train_on_transfer_final_batch8_beamsteer2, 2));
