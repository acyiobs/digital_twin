...
- Step 2: Run the main training scripts
  - python python/train_model_synth_measured.py
  - python python/train_model_synth_uniform.py
  - python python/train_model_real.py
- Step 3: Plot the performance
  - Run matlab/plot_performance_fig5.m in Matlab 
