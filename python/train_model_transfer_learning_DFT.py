...
if __name__ == "__main__":
    ...
    synth_beam_pwr_path = 'synth_beam_power_DFT.mat'
    ...
    print(all_acc)
    print(all_pwr)
    savemat('all_acc_train_on_transfer_final_batch8_DFT.mat', {'all_acc_train_on_transfer_final_batch8_DFT': all_acc})
    savemat('all_pwr_train_on_transfer_final_batch8_DFT.mat', {'all_pwr_train_on_transfer_final_batch8_DFT': all_pwr})
    print('done')
