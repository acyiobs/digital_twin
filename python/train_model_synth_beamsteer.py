...
if __name__ == "__main__":
    ...
    print(all_acc)
    print(all_pwr)
    savemat('all_acc_train_on_synth_beamsteer2.mat', {'all_acc_train_on_synth_beamsteer2': all_acc})
    savemat('all_pwr_train_on_synth_beamsteer2.mat', {'all_pwr_train_on_synth_beamsteer2': all_pwr})
    print('done')
