...
all_acc_train_on_real4 = mean(all_acc_train_on_real4, 2);
all_pwr_train_on_real4 = mean(all_pwr_train_on_real4, 2);
all_pwr_train_on_synth4 = mean(all_pwr_train_on_synth4, 2);
all_acc_train_on_synth4 = mean(all_acc_train_on_synth4, 2);
