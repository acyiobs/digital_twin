...
params.scenario= 'DeepSenseScenario1_v3';           % The adopted ray tracing scenarios [check the available scenarios at www.aalkhateeb.net/DeepMIMO.html]
...
params.active_user_last = 881;        % The last row of the considered receivers section (check the scenario description for the receiver row map)
...
params.num_ant=[1, 16, 1];         % Number of the UPA antenna array on the x,y,z-axes
...
params.num_ant_UE=[1, 1, 1];      % Number of the UPA antenna array on the x,y,z-axes


params.activate_array_rotation = 1;
params.array_rotation = [0, 0, 12.195564916031936];         
...
params.bandwidth=0.01;              % The bandwidth in GHz
