...
params.scenario= 'DeepSenseScenario1_v2';           % The adopted ray tracing scenarios [check the available scenarios at www.aalkhateeb.net/DeepMIMO.html]
...
params.array_rotation = [0, 0, 180+12.1956];         
