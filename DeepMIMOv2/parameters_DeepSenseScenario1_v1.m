...
params.scenario= 'DeepSenseScenario1_v1';           % The adopted ray tracing scenarios [check the available scenarios at www.aalkhateeb.net/DeepMIMO.html]
...
params.active_user_last = 92;        % The last row of the considered receivers section (check the scenario description for the receiver row map)
...
params.num_ant=[16, 1, 1];         % Number of the UPA antenna array on the x,y,z-axes
