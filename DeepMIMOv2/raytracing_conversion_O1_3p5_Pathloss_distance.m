...
for ii=1:1:num_BS % For each BS
    ...
    sfile_PL=strcat('Raytracing_scenarios/',scenario_write,'/',scenario_write,'.',num2str(ii),'.PL.mat');
...
for ii=1:1:num_TX_BS % For each BS transmitter
    ...
    % Write the PL output file
    sfile_PL=strcat('Raytracing_scenarios/',scenario_write,'/',scenario_write,'.',num2str(ii),'.PL.BSBS.mat');
