...
load('all_acc_train_on_transfer_final_batch8_DFT.mat');
load('all_pwr_train_on_transfer_final_batch8_DFT.mat');
...
all_acc_train_on_transfer_final = squeeze(mean(all_acc_train_on_transfer_final_batch8_DFT, 2));
all_pwr_train_on_transfer_final = squeeze(mean(all_pwr_train_on_transfer_final_batch8_DFT, 2));
