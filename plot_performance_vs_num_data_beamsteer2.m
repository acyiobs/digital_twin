...
load('all_acc_train_on_synth_beamsteer2.mat');
load('all_pwr_train_on_synth_beamsteer2.mat');


all_acc_train_on_real4 = squeeze(mean(all_acc_train_on_real4, 2));
all_pwr_train_on_real4 = squeeze(mean(all_pwr_train_on_real4, 2));
all_acc_train_on_synth4 = squeeze(mean(all_acc_train_on_synth_beamsteer2, 2));
all_pwr_train_on_synth4 = squeeze(mean(all_pwr_train_on_synth_beamsteer2, 2));
